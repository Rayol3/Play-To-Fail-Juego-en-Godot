...
func _on_Button_pressed():
	...
	get_tree().change_scene_to_file("res://Scenes/levels/Nivel 4/nivel1.tscn")

func _on_Button2_pressed():
	animationPlayer2.play("efecto(btn2)")
	get_tree().change_scene_to_file("res://Scenes/levels/Nivel 4/nivel2.tscn")

func _on_Button3_pressed():
	animationPlayer2.play("efecto(btn3)")
	get_tree().change_scene_to_file("res://Scenes/levels/Nivel 4/nivel3.tscn")

func _on_Button4_pressed():
	animationPlayer2.play("efecto(btn4)")
	get_tree().change_scene_to_file("res://Scenes/levels/Nivel 4/nivel4.tscn")
