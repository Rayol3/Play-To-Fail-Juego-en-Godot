...
func _on_Button_pressed():
	...
	get_tree().change_scene_to_file("res://Scenes/levels/Nivel 1/nivel1.tscn")
	$TextureRect6/AnimatedSprite.stop()
	
func _on_Button2_pressed():
	animationPlayer1.play("efecto(2)")
	get_tree().change_scene_to_file("res://Scenes/levels/Nivel 1/nivel2.tscn")
...
func _on_Button3_pressed():
	...
	get_tree().change_scene_to_file("res://Scenes/levels/Nivel 1/nivel3.tscn")
	$TextureRect6/AnimatedSprite.stop()


func _on_Button4_pressed():
	animationPlayer1.play("efecto(4)")
	get_tree().change_scene_to_file("res://Scenes/levels/Nivel 1/nivel4.tscn")
	$TextureRect6/AnimatedSprite.stop()
